...
Our extension is completely free to use and contains no advertisements. We are committed to providing a simple and distraction-free experience. The extension's source code is open and available for review on [GitHub](https://github.com/oe/cors-unlocker).
